...
public class CatalogueControllerIT {
    ...
    public void getBookByCatalogueId_success() throws Exception {
        mvc.perform(get("/catalogue/12-34-56-78-9"))
...
//                .andDo(MockMvcResultHandlers.print());
    ...
    public void getBookByCatalogueId_badRequest() throws Exception {
        mvc.perform(get("/catalogue/abcd-efgh"))
    ...
    public void getBookRating() throws Exception {
        mvc.perform(get("/catalogue/123456789/rating"))
                .andExpect(status().is2xxSuccessful())
    ...
    public void getBookReviews() throws Exception {
        mvc.perform(get("/catalogue/123456789/reviews"))
                .andExpect(status().is2xxSuccessful())
    ...
    public void getCategoryPathMap() throws Exception {
        mvc.perform(get("/catalogue/categories/9/path-map"))
                .andExpect(status().is2xxSuccessful())
    ...
    public void getCategoryTree() throws Exception {
        var result = mvc.perform(get("/catalogue/categories/tree"))
                .andExpect(status().is2xxSuccessful())
                .andDo(MockMvcResultHandlers.print())
                .andReturn();
